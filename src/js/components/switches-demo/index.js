...
function SwitchesDemo() {
	return <Switches {...{ data, title: 'Подключайте оборудование' }} className="demo" />
}
					...
					<React.Fragment>
						...
						<equipment-product>
							...
							<equipment-product-title>
								Ручной 2D сканер штрих-кода Honeywell Metrologic 1450g
							</equipment-product-title>
				...
				other={
					<React.Fragment>
						<equipment-product>
							...
							<equipment-product-title>
								Банковский терминал Ingenico IPP320{' '}
							</equipment-product-title>
				...
				other={
					<React.Fragment>
						<equipment-product>
							...
							<equipment-product-title>
								Весы Штрих-СЛИМ 300М 15-2.5 Д1 (POS2)
							</equipment-product-title>
...
export default hot(module)(SwitchesDemo)
